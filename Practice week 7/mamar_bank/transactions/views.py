...
from transactions.models import BankruptStatus
...
class SendMoneyView(TransactionCreateMixin):
    ...
    def form_valid(self, form):
        ...
        try :
            ...
            self.request.user.account.balance -= form.cleaned_data.get('amount')
            self.request.user.account.save(update_fields=['balance'])
            receiver.balance+=form.cleaned_data.get('amount')
            ...
            send_money_email(self.request.user,receiver, amount, "Send Money successfully", "transactions/sendmoney_email.html")
            send_money_email(receiver,self.request.user, amount, "Received money successfully", "transactions/sendmoney_email.html")
